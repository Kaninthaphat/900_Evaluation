...
public class view_911_waste_view {
	...
	{		
		...
		//{
	        ...
	        String StrSQL = "EXEC [914_WASTE_VIEW_Q] @START_DATE = '"+startDate_string+"',"
    ...
    public void exportListboxToExcel() throws Exception {
        ...
        AMedia amedia = new AMedia("waste_control.xlsx", "xls", "application/file", out.toByteArray());
